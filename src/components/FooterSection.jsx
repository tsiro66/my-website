...
const FooterSection = () => {
  ...
  return (
    <section className="min-h-screen bg-black flex flex-col justify-between snap-start">
      <div className="flex-1 flex items-center justify-center">
        <div className="container mx-auto px-12 md:px-20 lg:px-32 xl:px-40 text-center">
          ...
          <div className="flex gap-6 justify-center">
            <a 
              ...
              className="w-12 h-12 rounded-full bg-gray-900 flex items-center justify-center hover:bg-purple-600 transition-colors"
            >
